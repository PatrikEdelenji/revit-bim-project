...
def main():
    ...
    for index, case in enumerate(eval_cases, start=1):
        ...
        # LangChain tool names are slightly different from direct OpenAI tool names.
        # Example: query_rooms instead of query_rooms_tool.
        expected_tool = case.get("expected_tool")
        expected_langchain_tool = _map_expected_tool_name(expected_tool)

        tool_passed = True

        if expected_langchain_tool:
            tool_passed = expected_langchain_tool in selected_tools
